function [successful_key_door_episodes, successful_key_episodes, successful_easy_episodes, successful_basic_key_door, scores_vec,scores_vec_basic,score_key, total_episodes] = test_func_seperate_policy(W_ih_big, b_ih_big, W_ho_big, b_ho_big)
